...
## Inputs
Use the user's message that invoked this command as the TASK (feature/bug request).

## Hard constraints
- Do NOT edit files.
- If requirements are ambiguous in a way that changes the implementation, ask exactly 1 clarifying question; otherwise proceed with explicit assumptions.
- Optimize for minimal change set and lowest risk.

## Documentation freshness
If the TASK involves external libraries or APIs you're uncertain about, fetch current docs: use context7.
