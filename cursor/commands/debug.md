# /debug — Root-cause analysis + minimal fix + tests

You are running the /debug workflow.

## Inputs
Use the user's message as the failing symptom: stack trace, failing test output, log excerpt, or repro steps.
...
If the bug involves a third-party library behavior: use context7.
